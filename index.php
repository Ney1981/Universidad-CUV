...
<body>
            ...
            <div class="banner__content">
                <div class="banner__description">
                    <p class="banner__paragraph">
                        Descubre un mundo de conocimiento en línea: Tu aprendizaje, tu camino;
                        Conectando distancias, educando sin límites
                    </p>
                </div>
            ...
            <div class="lessons__container">
                ...
                <div class="lessons__description">
                    ...
                    <p class="lessons__information">
                        Su compromiso y pasión trascienden las pantallas, creando conexiones auténticas a pesar de la
                        distancia. Estos educadores no solo dominan su materia, sino que también dominan el arte de
                        involucrar, motivar y inspirar a través de plataformas digitales.
                    </p>
                </div>
            </div>
        </section>
        <section class="review">
            <h1 class="review__title">Reseñas</h1>
            ...
            <div class="contacto__container">
                ...
                <div class="contacto__data">
                    <form class="contacto__form">
                        ...
                        <p class="form__message">Regístrese ahora y obtenga acceso completo a nuestra aplicación.</p>
                        ...
                        <p class="form__signin">¿Ya tienes una cuenta? <a href="#">Iniciar sesión</a> </p>
                    </form>
                </div>
            </div>
        </section>
    ...
    <button class="button__fab" onclick="window.open('https://wa.me/573144895006/', '_blank')">
        <div id="block-chatwhatsapp" class="block block--code">
            <div class="conte wa-web">
                <div class="centered-content">
                    <img src="ruta_de_la_imagen_del_logo_de_whatsapp.png" alt="" class="whatsapp-logo">
                    <svg class="button__svg icon icon-tabler icon-tabler-brand-whatsapp" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
